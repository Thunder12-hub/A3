package sample.store;//Class representing an electronic store
...
public class ElectronicStore {
  ...
  public void sQuantity(int index) {
    int null_counter = 0;
    ...
    Product[] new_stock = new Product[MAX_PRODUCTS - null_counter];
    int increment = 0;
    for (int i = 0; i < stock.length; i++) {
      new_stock[increment] = stock[i];
      increment++;
    }
  }
  ...
  public static ElectronicStore createStore(){
    ...
    ElectronicStoreApp.stockQuantity.add(d1);
    ElectronicStoreApp.stockQuantity.add(d2);
    ElectronicStoreApp.stockQuantity.add(l1);
    ElectronicStoreApp.stockQuantity.add(l2);
    ElectronicStoreApp.stockQuantity.add(f1);
    ElectronicStoreApp.stockQuantity.add(f2);
    ElectronicStoreApp.stockQuantity.add(t1);
    ElectronicStoreApp.stockQuantity.add(t2);
